...
$CONTLOGOTITLE  = 'CORPORACION ALIMENTICIA';
$CONTLOGOSUBTITLE  = 'RUC: ';
$INPELOGOTITLE  = 'INSTITUTO NACIONAL PENITENCIARIO';
$INPELOGOSUBTITLE  = 'OFICINA REGIONAL ORIENTE PUCALLPA';
