...
<h4 class="header2"><?php echo (__('Tecnicos de CMC',true));?></h4>	
	...
	<?php echo $this->Element('buscador', array('elementos'=>$elementos,'url' => 'indextecnicos')); ?>
...
<table class="striped">
	...
	<tbody>
		...
		<tr>
			...
			<td class="actions">	
				<?php if($secassign['Secperson']['generated']==0) echo $this->Html->link(__('Asignar'), array('controller'=>'secpeople','action' => 'asignar', $secassign['Secassign']['secperson_id'],$secassign['Secassign']['secproject_id']),array('class'=>'waves-effect waves-light btn pink')); ?>	
			</td>
		</tr>
		<?php endforeach; ?>
	</tbody>
