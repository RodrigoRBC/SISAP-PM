                ...
                <div class="row">
                    ...
                    <div class="col col s8 m8 l8">
                        <ul id="profile-dropdown" class="dropdown-content">
                            <li><a href="#" style='font-size:0.6em;'><!--<i class="mdi-action-face-unlock"></i>--><?php echo $datosLogeo['0']['Secorganization']['name'];?></a>
                            </li>
                            <li><a href="#" style='font-size:0.6em;'><!--<i class="mdi-action-settings"></i>--><?php echo $datosLogeo['0']['Secproject']['name'];?></a>
                            </li>
