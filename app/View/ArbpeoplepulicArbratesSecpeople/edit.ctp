...
<?php echo $this->Form->create('ArbpeoplepulicArbratesSecperson'); ?>
	<fieldset>
		<legend><?php echo __('Edit Arbpeoplepulic Arbrates Secperson'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ArbpeoplepulicArbratesSecperson.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ArbpeoplepulicArbratesSecperson.id')))); ?></li>
