<div class="arbrates index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('numper_people'); ?></th>
			<th><?php echo $this->Paginator->sort('calculate_rate'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($arbrate['Arbrate']['numper_people']); ?>&nbsp;</td>
		<td><?php echo h($arbrate['Arbrate']['calculate_rate']); ?>&nbsp;</td>
		<td><?php echo h($arbrate['Arbrate']['creationdate']); ?>&nbsp;</td>
