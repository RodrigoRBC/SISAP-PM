  ...
  public function ColoredTable($header, $data) {
    ...
    foreach ($data as $keydata => $valuedata) {
      $this->core->Cell($w[0], 6, $keydata + 1, 'LR', 0, 'C', $fill);
			$this->core->Cell($w[1], 6, $valuedata['Arbrate']['creationdate'], 'LR', 0, 'C', $fill);
			$this->core->Cell($w[2], 6, $valuedata['ArbpeoplepulicArbrate']['fecha'], 'LR', 0, 'C', $fill);
			$this->core->Cell($w[3], 6, $valuedata['ArbpeoplepulicArbrate']['period'], 'LR', 0, 'R', $fill);
      $this->core->Cell($w[4], 6, $valuedata['ArbpeoplepulicArbrate']['description'], 'LR', 0, 'L', $fill);
      $this->core->Ln();
			$fill=!$fill;
    }
