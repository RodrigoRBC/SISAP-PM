<?php echo $this->Form->create('Secperson',array('action' => 'modificarpassword'));?>
	...
	<br/>
	<div class="ui blue inverted segment" ><?php echo __('modificarContrasenia',true);?>
	</div>
	<hr/>
	...
	<div class=" span-9 botones" >
			<?php echo $this->Form->submit(__('Guardar',true), array('class'=>'ui button','div'=>false));	?>						
			<?php echo $this->Form->button(__('Cerrar',true), array('class'=>'ui button','type'=>'button','onClick' => 'javascript:window.close()')); ?>
	</div>
