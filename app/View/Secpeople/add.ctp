...
<div class="col s12 m12 112">
	...
	<div class="row">
		...
		<div class="input-field col s12" >
				<?php echo $this->Form->text('username',array('required'=>'required')); 
		...
		<div class="input-field col s12" >
				<?php echo $this->Form->password('password',array('required'=>'required'));
				echo $this->Form->error('password', array(															
													   	'notEmpty' =>  __('personaContraseniaNoVacio', true),									      
														), array('class' => 'input text required error'));
				?>
	     	<label for="SecpersonPassword"><?php echo __('contrasenia').'*'; ?></label>
		</div>
