<div class='span-8'>
	...
	<?php echo $this->Form->create('Secorganization', array('action'=>'logisticaedit'));?>
		...
		<div class=" span-8 botones" >
			<?php echo $this->Form->submit(__('Submit',true), array('div'=>false,'class'=>'ui button'));?>
			<?php echo $this->Form->button(__('Reset',true), array('type'=>'reset','class'=>'ui button'));?>				
			<?php echo $this->Form->button(__('Close',true), array('type'=>'button','onClick' => 'window.history.back()','class'=>'ui button')); ?>
		</div>
