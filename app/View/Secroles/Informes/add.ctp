...
<div class="col s12 m12 112">
	...
	<div class="input-field center col s12" >
		...
		<?php echo $this->Html->link('Imprimir Constancia','constancia/'.$cmc_id.'/'.$informe['Informe']['id'],array("target"=>"_blank",'class' => 'waves-effect waves-light btn teal','escape'=>false),null); ?>
	</div>
