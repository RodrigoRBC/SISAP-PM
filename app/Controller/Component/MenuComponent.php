...
class MenuComponent extends Component
{
	...
	public function agregarTagArbol($arrego, $modelo, $etiqueta)
	{
		$programas = $arrego;
		$menu = '';
		$tagCierre = '';
	...
	public function agregarTagArbolold($arrego, $modelo, $etiqueta)
	{
		$programas = $arrego;
		$menu = '';
		$tagCierre = '';
		...
		{			
			...
			else
			{
				...
				if($programa[$modelo]['lft'] > $programas[$key-1][$modelo]['lft'] && 
					$programa[$modelo]['lft'] < $programas[$key-1][$modelo]['rght'])				
					//$tagInicio = '<br/>&lt;ul&gt;<br/>&lt;li&gt;';
					$tagInicio = '<div class="collapsible-body"><ul><li>';
				else					
					//$tagInicio = '<br/>&lt;li&gt;';
					$tagInicio = '</li><li>';
			}
